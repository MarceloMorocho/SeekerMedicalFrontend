...
@Component({
  ...
  templateUrl: './listado-medico.page.html',
  styleUrls: ['./listado-medico.page.scss'],
})

export class ListadoMedicoPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.obtenerListadoMedicos(); // Llamar a obtenerListadoMedicos()
  ...
  // Método para establecer el médico seleccionado al pasar el ratón
  establecerMedicoSeleccionado(medico: any) {
    this.medicoSeleccionado = medico;
  }

  // Método para deseleccionar el médico al salir del ratón
  deseleccionarMedico() {
  ...
  async filtrarListadoMedicos() {
    ...
    this.listaMedicos = this.listaMedicos.filter((medico) => {
      ...
      if (pasaFiltros) {
        ...
        console.log(`Médico ${medico.medicosResponse}:`);
  ...
  // Método para navegar a la página de información del médico con parámetros
